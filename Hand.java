...
public class Hand {
    ...
    private double numBets = 1;   // The number of bets on this hand. Can be one or two
    private int outcome = -1; // The outcome of this hand
    private boolean bust = false; // Did the user bust?
    private boolean blackjacked = false; // Is this hand a blackjack?
    private boolean charliehand = false; // Is this a win by charlie hand?
    ...
    public void charlied() {
    	charliehand = true;
    }
   
    public boolean didCharlie() {
    	return charliehand;
    }
